...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kgoldrunner-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kgoldrunner-25.04.1.tar.xz.sig
...
%setup -q -n kgoldrunner-25.04.1
cd %{_builddir}/kgoldrunner-25.04.1
pushd ..
cp -a kgoldrunner-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747173373
mkdir -p clr-build
pushd clr-build
