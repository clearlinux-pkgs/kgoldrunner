...
Version  : 24.02.1
Release  : 65
URL      : https://download.kde.org/stable/release-service/24.02.1/src/kgoldrunner-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/kgoldrunner-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/kgoldrunner-24.02.1.tar.xz.sig
...
%prep
%setup -q -n kgoldrunner-24.02.1
cd %{_builddir}/kgoldrunner-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711091125
mkdir -p clr-build
pushd clr-build
