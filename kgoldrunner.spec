...
Version  : 23.04.1
Release  : 53
URL      : https://download.kde.org/stable/release-service/23.04.1/src/kgoldrunner-23.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kgoldrunner-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kgoldrunner-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kgoldrunner-23.04.1
cd %{_builddir}/kgoldrunner-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684815126
mkdir -p clr-build
pushd clr-build
