...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kgoldrunner-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kgoldrunner-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kgoldrunner-23.04.0
cd %{_builddir}/kgoldrunner-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682096870
mkdir -p clr-build
pushd clr-build
