...
Version  : 24.12.3
Release  : 80
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kgoldrunner-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kgoldrunner-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kgoldrunner-24.12.3.tar.xz.sig
...
%setup -q -n kgoldrunner-24.12.3
cd %{_builddir}/kgoldrunner-24.12.3
pushd ..
cp -a kgoldrunner-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742498437
mkdir -p clr-build
pushd clr-build
