...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kgoldrunner-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kgoldrunner-24.08.0.tar.xz.sig
...
%setup -q -n kgoldrunner-24.08.0
cd %{_builddir}/kgoldrunner-24.08.0
pushd ..
cp -a kgoldrunner-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724650993
mkdir -p clr-build
pushd clr-build
